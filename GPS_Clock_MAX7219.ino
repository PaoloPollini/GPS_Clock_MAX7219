...
byte TIMEZONE = 3;                                // Часовой пояс
static const uint32_t GPSBaud = 9600;             // скорость порта GPS модуля


byte screen=3;                                    // Набор символов, отображаемый в текущий момент времени на экране
...
byte lastScreen = 1;                              // Запоминаем последний отображаемый экран
...
EncButton2<EB_BTN> btn(INPUT, BUTTON_PIN);        // сенсорная кнопка
